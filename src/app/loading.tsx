        ...
        <div className="space-y-8 text-center">
          ...
          <div className="relative w-48 h-48 mx-auto">
            <RetroCard variant="secondary" className="relative aspect-square">
              <div className="absolute inset-0 bg-navy-800/80 border-2 border-accent-green/20 animate-pulse">
                {/* Decorative grid lines */}
                <div className="absolute inset-0 grid grid-cols-3 grid-rows-3">
                  {[...Array(9)].map((_, i) => (
                    <div
                      key={i}
                      className="border border-accent-green/10"
                    />
                  ))}
                </div>
                ...
                <div className="absolute inset-0 m-auto w-12 h-12 flex items-center justify-center">
                  <div className="text-accent-green/40 text-3xl animate-bounce">
                    ♪
                  </div>
                </div>
              </div>
          ...
          <div className="relative h-2 w-64 mx-auto bg-navy-800/50 rounded-full overflow-hidden">
            <div className="absolute inset-0 bg-gradient-to-r from-accent-orange via-accent-green to-accent-orange animate-gradient" />
          </div>
